...
public class Util {
	...
	public static void initTextureData() throws IOException {
		...
		if (ConfigHandler.replaceMainMenuLogo) {
			...
			Minecraft.getInstance().getTextureManager().register(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "logo"), logoTexture);
		...
		if (ConfigHandler.setCustomBackground) {
			...
			Minecraft.getInstance().getTextureManager().register(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "background"), backgroundTexture);
